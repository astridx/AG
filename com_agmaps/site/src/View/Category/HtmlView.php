...
namespace AgmapNamespace\Component\Agmaps\Site\View\Category;
...
/**
 * HTML View class for the Agmaps component
 *
...
class HtmlView extends CategoryView
{
	...
	protected function prepareDocument()
	{
			...
			|| $id != $this->category->id))
		{
			...
			while ((!isset($menu->query['option']) || $menu->query['option'] !== 'com_agmaps' || $menu->query['view'] === 'agmap'
