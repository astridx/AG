...
namespace AgmapNamespace\Component\Agmaps\Site\Controller;
...
/**
 * Controller for single agmap view
 *
...
class AgmapController extends FormController
{
	...
	protected function allowAdd($data = array())
	{
		if ($categoryId = ArrayHelper::getValue($data, 'catid', $this->input->getInt('catid'), 'int'))
		{
			...
			return $user->authorise('core.create', 'com_agmaps.category.' . $categoryId);
		}
