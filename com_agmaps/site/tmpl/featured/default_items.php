...
<div class="com-agmaps-featured__items">
	<?php if (empty($this->items)) : ?>
		<p class="com-agmaps-featured__message"> <?php echo Text::_('COM_FOO_NO_FOOS'); ?>	 </p>
	<?php else : ?>

	<form action="<?php echo htmlspecialchars(Uri::getInstance()->toString()); ?>" method="post" name="adminForm" id="adminForm">
		<table class="com-agmaps-featured__table table">
