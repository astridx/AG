					...
					<div class="logo container">
						<div>
							<?php if ($this->params->get('siteTitle')) : ?>
								<h1><a href="<?php echo $this->baseurl; ?>/" id="logo"><?php echo htmlspecialchars($this->params->get('siteTitle')); ?></a></h1>
							<?php endif; ?>

							<?php if ($this->params->get('siteDescription')) : ?>
								<p><?php echo htmlspecialchars($this->params->get('siteDescription')); ?></p>
							<?php endif; ?>
						</div>
					</div>
				</header>
